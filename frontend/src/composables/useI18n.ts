...
const defaultTexts: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    'admin.projectDescription': 'CFpanel Cloudflare 是一个专为 Cloudflare 优化的开源导航面板项目。',
    ...
    'groups.external': '外网',
    'groups.internalUrl': '内网地址',
    'groups.internalUrlPlaceholder': 'http://192.168.1.xxx:port/path',
    'groups.internalUrlHint': '支持内网IP地址或域名，如: http://192.168.1.100:8080',
    'dashboard.title': '仪表盘',
  ...
  'en-US': {
    ...
    'admin.projectDescription': 'CFpanel Cloudflare is an open-source navigation panel optimized for Cloudflare.',
    ...
    'nav.home': 'Home',
    'home.welcome': 'Welcome to CFpanel',
    ...
    'groups.internalUrl': 'Internal URL',
    'groups.internalUrlPlaceholder': 'http://192.168.1.xxx:port/path',
    'groups.internalUrlHint': 'Supports internal IP addresses or domain names, e.g., http://192.168.1.100:8080',
