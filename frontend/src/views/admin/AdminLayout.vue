...
<style scoped>
.menu-item {
  @apply flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-slate-200 transition-all duration-300 hover:shadow-sm;
}

.menu-item.active {
  @apply bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 shadow-glow-sm;
}
